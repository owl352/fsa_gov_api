...
export const declarationDecodeSchema = new Schema({
  ...
  ccDcChangeReason: { type: Schema.Types.Mixed, index: true },
  testingStatus: { type: Schema.Types.Mixed, index: true },
  fiasAddrobj: { type: Schema.Types.Mixed, index: true },
  fiasHouse: { type: Schema.Types.Mixed, index: true },
  tnved: { type: Schema.Types.Mixed, index: true },
  okpd2: { type: Schema.Types.Mixed, index: true },
  singleListRU: { type: Schema.Types.Mixed, index: true },
